...
/**
 * A class representing a composite primary key id for the Appointments
 * table.  This object should only be instantiated for use with instances 
 * of the Appointments class.
 */
public class AppointmentsKey
    implements Serializable
{
    ...
    /**
     * Simple constructor of AppointmentsKey instances.
     */
    public AppointmentsKey()
    {
    }
    ...
    public boolean equals(Object rhs)
    {
        if (rhs == null)
            return false;
        if (! (rhs instanceof AppointmentsKey))
            return false;
        AppointmentsKey that = (AppointmentsKey) rhs;
