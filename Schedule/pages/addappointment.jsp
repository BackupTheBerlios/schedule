...
<title>Appointment hinzufügen</title>
...
<f:view>
	...
	%></td>
					...
					<tr height="40">
						<td>
							Auf dieser Seite können Sie einen neuen Termin anlegen.
						</td>
					</tr>
					<tr height="200">
						...
						<table>
							...
							<tr>
								...
								<td>Projekt:</td><td><h:selectOneMenu value="#{AppointmentBean.tmpCurrProj}">
								<f:selectItems value="#{ProjectBean.projectListArray}" />
							</h:selectOneMenu></td>
							</tr>
							<tr>	
								<td>Terminüberschrift:</td>
								<td><h:inputText id="appointName" value="#{AppointmentBean.subject}" size="42" /></td>
							</tr>
						
							<tr>
								<td>Beschreibung:</td>
								<td><h:inputTextarea id="appointDescr"
									value="#{AppointmentBean.description}" cols="39" rows="10" />
							...
							<tr>
								<td>Termindatum:</td>
								<td><h:inputText id="appointDate" value="#{AppointmentBean.date}" size="42">
							...
							<tr>
								<td><h:commandButton id="submit"
									action="#{AppointmentBean.addAppointment}"
									value="senden" /></td>
								<td></td>
							</tr>
							<tr><td>
