		...
		<tr height="100">
			...
			<table width="549" border="0" cellspacing="0" cellpadding="0"
				...
				<tr height="70">
					...
					<div align="left"><font size="5">ProjectPlaner</font></div>
					</td>
				</tr>
				<tr bgcolor="#103052" height="30">
			...
			<table width="549" border="0" cellspacing="0" cellpadding="0">
				<h:form id="loginForm">
					<tr height="130">
						...
						<p><h:outputText value="#{bundle.login_comment}" /></p>
						<table>
							<tbody>
								<tr>
									<td><h:outputText value="#{bundle.user_name_label}" /></td>
									<td><h:inputText id="userName" value="#{LoginBean.screenname}"
										required="true">
								...
								<tr>
									<td colspan="2"><h:messages
										style="font-weight: bold; color: #FF0000;" /></td>
								</tr>
								<tr>
									<td align="right" colspan="2"><h:commandButton id="submit"
