	...
	<h:form id="mainForm">
		<table>
			...
			Internaionization fuer beschriftung labels u Buttons ------>
				<td>Project name:</td>
				<td><h:inputText id="projName" value="#{ProjectBean.name}"
					required="true" /></td>
			</tr>
			<tr>
				<td>Description:</td>
				<td><h:inputText id="projDescr" value="#{ProjectBean.description}"
					required="true" /></td>
			</tr>
			<tr>
				<td><h:commandButton id="submit" action="#{ProjectBean.addProject}"
