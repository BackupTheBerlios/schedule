...
<title>Projektmitglieder hinzufügen</title>
...
<f:view>
	...
	%></td>
					...
					<tr height="60">
						<td>
						<h1>Neue Nutzer hinzuf&uuml;gen</h1>
						</td>
					</tr>
					<tr height="40">
						<td>
							Auf dieser Seite können Sie ihrem Projekt neue Nutzer hinzuf&uuml;gen.
						</td>
					</tr>
					<tr height="200">
						...
						<table>
							...
							<tr>
								...
								<f:selectItems value="#{ProjectBean.allUserListArray}" />
							</h:selectOneMenu></td>
							</tr>
							...
							<tr>
								<td>
									...
									action="#{ProjectBean.addUserToProjectTeam}"
									value="hinzufügen" >
