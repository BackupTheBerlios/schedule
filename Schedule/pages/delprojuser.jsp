...
<title>Projektmitglieder entfernen</title>
...
<f:view>
	...
	%></td>
					...
					<tr height="60">
						<td>
						<h1>Projektmitglieder entfernen</h1>
						</td>
					</tr>
					<tr height="40">
						<td>
							Auf dieser Seite können Sie Nutzer aus ihrem Projekt entfernen.
						</td>
					</tr>
					<tr height="200">
						...
						<table>
							...
							<tr>
								...
								<td>Projekt:</td><td><h:outputText value="#{ProjectBean.addUserToProject.name}"/></td>
							</tr>
							<tr>
								
								
								<td>User:</td><td><h:selectOneMenu value="#{ProjectBean.tempAddUser}">
								<f:selectItems value="#{ProjectBean.allProjectUserListArray}" />
							</h:selectOneMenu></td>
							</tr>
							...
							<tr>
								<td>
									...
									action="#{ProjectBean.delUserFromProjectTeam}"
									value="entfernen" >
